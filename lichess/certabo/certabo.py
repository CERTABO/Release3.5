...
from lichess.certabo import serialreader
...
class Certabo():
    def __init__(self, port='auto', calibrate=0, **kwargs):
        ...
        self.calibration_data_path = os.path.join(CERTABO_DATA_PATH, f'calibration-{self.portname.replace("/", "")}.bin')
        codes.load_calibration(self.calibration_data_path)
